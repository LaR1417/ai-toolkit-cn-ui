      ...
      >
        ...
        <div className={topBarClass}>
            ...
            {modelArch?.additionalSections?.includes('model.layer_offloading') && !isMac() && (
              <>
                <Checkbox
                  label={
                    <>
                      层卸载 <IoFlaskSharp className="inline text-yellow-500" name="实验性" />{' '}
                    </>
                  }
          ...
          {!disableSections.includes('slider') && (
            <Card title="滑块">
              ...
              <TextInput
                ...
                placeholder="如 person who is happy"
              />
              <TextInput
                label="反向提示词"
                className=""
                ...
                placeholder="如 person who is sad"
              />
              <TextInput
                label="锚定类别"
                className=""
          ...
          <Card title="保存">
            ...
            <NumberInput
              label="最大保存数"
              docKey="save.max_step_saves_to_keep"
            ...
            <div className={trainingBarClass}>
              ...
              <div>
                <FormGroup label="EMA（指数移动平均）">
                  <Checkbox
                    label="使用 EMA"
                    docKey="train.ema_config.use_ema"
                    className="pt-1"
                ...
                {jobConfig.config.process[0].train.ema_config?.use_ema && (
                  <NumberInput
                    label="EMA 衰减"
                    docKey="train.ema_config.ema_decay"
                    className="pt-2"
                  ...
                  <>
                    ...
                    {jobConfig.config.process[0].train.diff_output_preservation && (
                      <>
                        <NumberInput
                          label="DOP 损失倍率"
                          docKey="train.dop_loss_multiplier"
                          className="pt-2"
                        ...
                        <TextInput
                          label="DOP 保留类别"
                          docKey="train.dop_preservation_class"
                          className="pt-2 pb-4"
                  ...
                  <>
                    ...
                    {jobConfig.config.process[0].train.blank_prompt_preservation && (
                      <>
                        <NumberInput
                          label="BPP 损失倍率"
                          docKey="train.bpp_loss_multiplier"
                          className="pt-2"
                          value={
              ...
              <div>
                ...
                {jobConfig.config.process[0].train.differential_guidance_scale && (
                  <>
                    <NumberInput
                      label="差分引导比例"
                      docKey="train.differential_guidance_scale"
                      className="pt-2"
                  ...
                  <div className={datasetStyleClass}>
                    ...
                    <div>
                      <TextInput
                        ...
                        placeholder="如 A photo of a cat"
                      />
                      <NumberInput
                        label="标注丢弃率"
                    ...
                    <div>
                      <FormGroup label="设置" className="">
                        <Checkbox
                          label="缓存 Latents"
                          docKey="datasets.cache_latents_to_disk"
                        ...
                        <Checkbox
                          label="正则化数据"
                          docKey="datasets.is_regularization"
                    ...
                    {!isAudioModel && (
                      <div>
                        <FormGroup label="分辨率" docKey="datasets.resolution" className="pt-2">
              ...
              <div>
                <FormGroup label="高级采样" className="pt-2">
                  <div>
                    <Checkbox
                      label="跳过首次采样"
                      docKey="sample.skip_first_sample"
                      className="pt-4"
                  ...
                  <div>
                    <Checkbox
                      label="禁用采样"
                      docKey="sample.disable_sampling"
                      className="pt-1"
