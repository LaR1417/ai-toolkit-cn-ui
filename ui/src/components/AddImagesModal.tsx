              ...
              <div className="text-center">
                ...
                <div {...getRootProps()} className="w-full">
                  ...
                  >
                    ...
                    {!isUploading ? (
                      <>
                        <p className="text-sm text-gray-200 text-center">拖放文件到此处或点击选择</p>
                        <p className="text-xs text-gray-400 mt-1">支持图片、视频或 .txt 文件</p>
                      </>
                    ) : (
                      <p className="text-sm text-gray-200 text-center">拖放更多文件以添加到队列</p>
                    )}
                  </div>
                </div>
