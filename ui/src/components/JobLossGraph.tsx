    ...
    <div className="bg-gray-900 rounded-xl shadow-lg overflow-hidden border border-gray-800 flex flex-col">
      <div className="bg-gray-800 px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-gray-100 text-sm font-medium">损失图表</h2>
              ...
              >
                ...
                {!isDragging && (
                  <Tooltip
                    ...
                    labelFormatter={(label: any) => `步数 ${label}`}
      ...
      <div className="px-4 pb-2">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          <div className="bg-gray-950 border border-gray-800 rounded-lg p-3">
            ...
            {lossKeys.length === 0 ? (
              <div className="text-sm text-gray-400">暂未找到损失键。</div>
            ) : (
              <div className="flex flex-wrap gap-2">
                {lossKeys.map(k => (
                  <button
          ...
          <div className="bg-gray-950 border border-gray-800 rounded-lg p-3">
            ...
            <input
              ...
              className="w-full accent-blue-500"
            />
            <div className="mt-2 text-[11px] text-gray-500">大规模运行的界面降采样。</div>
          </div>
